...
export type CommonDict = {
  ...
  auth: {
    ...
    emailSentText: (email: string) => string;
...
export const commonDict: Record<Locale, CommonDict> = {
  de: {
    nav: {
      ...
      wohngeld: "Wohngeld",
      alg1Rechner: "Arbeitslosengeld-Rechner",
      bafoegRechner: "BAföG-Rechner",
      datenbank: "Datenbank",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "ALG1-Anspruch und Höhe in wenigen Minuten schätzen",
      bafoegRechner: "BAföG-Anspruch und Höhe schnell schätzen",
    ...
    auth: {
      ...
      forgotSoon: "In Kürze verfügbar",
      emailSentTitle: "Konto erstellt",
      emailSentText: (email: string) => `Wir haben eine Bestätigungs-E-Mail an ${email} gesendet.`,
      emailSentHint: "Bitte bestätige dein Konto, bevor du dich anmeldest.",
  ...
  en: {
    nav: {
      ...
      alg1Rechner: "Unemployment Benefit Calculator",
      bafoegRechner: "BAföG Calculator",
      datenbank: "Database",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "Estimate your unemployment benefit entitlement and amount in minutes",
      bafoegRechner: "Estimate your BAföG entitlement and amount",
    ...
    auth: {
      ...
      forgotSoon: "Coming soon",
      emailSentTitle: "Account created",
      emailSentText: (email: string) => `We sent a confirmation email to ${email}.`,
      emailSentHint: "Please confirm your account before signing in.",
  ...
  ar: {
    nav: {
      ...
      alg1Rechner: "حاسبة إعانة البطالة",
      bafoegRechner: "حاسبة BAföG",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "قدّر استحقاقك ومبلغ إعانة البطالة خلال دقائق",
      bafoegRechner: "قدّر استحقاقك من BAföG والمبلغ بسرعة",
    ...
    navbar: { skipToContent: "الانتقال إلى المحتوى", menuOpen: "فتح القائمة", menuClose: "إغلاق القائمة", language: "اللغة", mainNavLabel: "التنقل الرئيسي", mobileNavLabel: "Mobile Navigation",
    ...
    auth: {
      ...
      forgotSoon: "قريبًا",
      emailSentTitle: "تم إنشاء الحساب",
      emailSentText: (email: string) => `أرسلنا بريدًا تأكيديًا إلى ${email}.`,
      emailSentHint: "يرجى تأكيد حسابك قبل تسجيل الدخول.",
  ...
  tr: {
    nav: {
      ...
      alg1Rechner: "İşsizlik Maaşı Hesaplayıcı",
      bafoegRechner: "BAföG Hesaplayıcı",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "İşsizlik maaşı hakkını ve tutarını birkaç dakikada tahmin et",
      bafoegRechner: "BAföG hakkını ve tutarını hızlıca tahmin et",
    ...
    navbar: { skipToContent: "İçeriğe atla", menuOpen: "Menüyü aç", menuClose: "Menüyü kapat", language: "Dil", mainNavLabel: "Ana gezinme", mobileNavLabel: "Mobile Navigation",
    dashboard: "Panel",
    abmelden: "Çıkış yap",
    anmelden: "Giriş yap",
    ...
    auth: {
      ...
      error: "Hata",
      loading: "Yükleniyor…",
      forgotPassword: "Parola yenile",
      forgotSoon: "Yakında",
      emailSentTitle: "Hesap oluşturuldu",
      emailSentText: (email: string) => `Doğrulama e-postası ${email} adresinize gönderildi.`,
      emailSentHint: "Giriş yapmadan önce hesabınızı doğrulayın.",
      backToForm: "Forma geri dön",
      profile: "Profilim",
      logout: "Çıkış yap",
      login: "Giriş yap",
      signup: "Hesap oluştur",
      sessionExpired: "Oturumunuz geçersiz. Lütfen tekrar giriş yapın.",
      invalidCredentials: "E-posta veya parola yanlış.",
      emailExists: "Bu e-posta zaten kaydedilmiş.",
      localeLabel: "Dil",
      localeDe: "Alman",
      localeEn: "İngilizce",
  ...
  ru: {
    nav: {
      ...
      alg1Rechner: "Калькулятор пособия по безработице",
      bafoegRechner: "Калькулятор BAföG",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "Оцени право и размер пособия по безработице за пару минут",
      bafoegRechner: "Быстро оцени право на BAföG и сумму",
    ...
    navbar: { skipToContent: "Перейти к содержимому", menuOpen: "Открыть меню", menuClose: "Закрыть меню", language: "Язык", mainNavLabel: "Основная навигация", mobileNavLabel: "Mobile Navigation",
    dashboard: "Панель",
    abmelden: "Выйти",
    anmelden: "Войти",
    ...
    auth: {
      ...
      forgotSoon: "Скоро",
      emailSentTitle: "Аккаунт создан",
      emailSentText: (email: string) => `На ${email} отправлено подтверждение.`,
      emailSentHint: "Подтвердите аккаунт перед входом.",
  ...
  uk: {
    nav: {
      ...
      alg1Rechner: "Калькулятор допомоги з безробіття",
      bafoegRechner: "Калькулятор BAföG",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "Оціни право та розмір допомоги з безробіття за кілька хвилин",
      bafoegRechner: "Швидко оціни право на BAföG та суму",
    ...
    navbar: { skipToContent: "Перейти до вмісту", menuOpen: "Відкрити меню", menuClose: "Закрити меню", language: "Мова", mainNavLabel: "Основна навігація", mobileNavLabel: "Mobile Navigation",
    dashboard: "Панель",
    abmelden: "Вийти",
    anmelden: "Увійти",
    ...
    auth: {
      ...
      forgotSoon: "Скоро",
      emailSentTitle: "Акаунт створено",
      emailSentText: (email: string) => `На ${email} надіслано підтвердження.`,
      emailSentHint: "Підтвердьте акаунт перед входом.",
      ...
      emailExists: "Ця електронна пошта вже зареєстрована.",
      localeLabel: "Мова",
      localeDe: "Німецька",
      localeEn: "Англійська",
  ...
  pl: {
    nav: {
      ...
      alg1Rechner: "Kalkulator zasiłku dla bezrobotnych",
      bafoegRechner: "Kalkulator BAföG",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "Sprawdź prawo i wysokość zasiłku w kilka minut",
      bafoegRechner: "Szybko oszacuj uprawnienie do BAföG i kwotę",
    ...
    navbar: { skipToContent: "Przejdź do treści", menuOpen: "Otwórz menu", menuClose: "Zamknij menu", language: "Język", mainNavLabel: "Nawigacja główna", mobileNavLabel: "Mobile Navigation",
    dashboard: "Panel",
    ...
    auth: {
      ...
      forgotSoon: "Wkrótce",
      emailSentTitle: "Konto utworzone",
      emailSentText: (email: string) => `Wysłaliśmy e-mail z potwierdzeniem na ${email}.`,
      emailSentHint: "Potwierdź konto przed zalogowaniem.",
  ...
  bg: {
    nav: {
      ...
      wohngeld: "Жилищно подпомагане",
      alg1Rechner: "Калкулатор за помощи при безработица",
      bafoegRechner: "Калкулатор BAföG",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "Оцени правото и размера на помощта за минути",
      bafoegRechner: "Бързо изчисли право на BAföG и сумата",
    ...
    navbar: { skipToContent: "Към съдържанието", menuOpen: "Отвори менюто", menuClose: "Затвори менюто", language: "Език", mainNavLabel: "Основна навигация", mobileNavLabel: "Mobile Navigation",
    dashboard: "Табло",
    abmelden: "Излезте",
    anmelden: "Влезте",
    kontoErstellen: "Създайте профил" },
    auth: {
      emailLabel: "Имейл",
      passwortLabel: "Парола",
      nameLabel: "Име",
      nameOptional: "(незадължително)",
      passwordLabel: "Парола",
      confirmPasswordLabel: "Потвърдете паролата",
      passwordTooShort: "Паролата трябва да има поне 6 символа.",
      ...
      forgotSoon: "Скоро",
      emailSentTitle: "Профил създаден",
      emailSentText: (email: string) => `Изпратихме потвърдителна имейл до ${email}.`,
      emailSentHint: "Потвърдете профила си, преди да влезете.",
      backToForm: "Обратно към формуляра",
      profile: "Моят профил",
      logout: "Изход",
      login: "Вход",
      signup: "Създай профил",
      sessionExpired: "Сесията ви изтече. Моля, влезте отново.",
      invalidCredentials: "Имейл или парола са неправилни.",
      emailExists: "Този имейл вече е регистриран.",
      localeLabel: "Език",
      localeDe: "Немска",
      localeEn: "Английски",
      success: "Успешно влезли.",
    },
    navbarAuth: {
      anmelden: "Вход",
      kontoErstellen: "Създай профил",
      profil: "Профил",
      abmelden: "Изход",
    },
    footer: {
  ...
  ro: {
    nav: {
      ...
      wohngeld: "Ajutor de locuit",
      alg1Rechner: "Calculator de ajutor de șomaj",
      bafoegRechner: "Calculator BAföG",
    ...
    navDescriptions: {
      ...
      alg1Rechner: "Estimează dreptul și cuantumul ajutorului în câteva minute",
      bafoegRechner: "Estimează rapid dreptul la BAföG și suma",
    ...
    navbar: { skipToContent: "Sari la conținut", menuOpen: "Deschide meniul", menuClose: "Închide meniul", language: "Limba", mainNavLabel: "Navigare principală", mobileNavLabel: "Mobile Navigation",
    dashboard: "Panou",
    abmelden: "Deconectează-te",
    anmelden: "Conectează-te",
    kontoErstellen: "Creează cont" },
    auth: {
      emailLabel: "Adresă de e-mail",
      passwortLabel: "Parolă",
      nameLabel: "Nume",
      nameOptional: "(opțional)",
      ...
      forgotSoon: "Curând",
      emailSentTitle: "Cont creat",
      emailSentText: (email: string) => `Am trimis un e-mail de confirmare către ${email}.`,
      emailSentHint: "Confirmă contul înainte de autentificare.",
      backToForm: "Înapoi la formular",
      profile: "Profilul meu",
      logout: "Déconectare",
      login: "Autentificare",
      signup: "Creează cont",
      sessionExpired: "Sesiunea a expirat. Te autentifici din nou.",
      invalidCredentials: "E-mail sau parolă incorectă.",
      emailExists: "Acest e-mail este already înregistrat.",
      localeLabel: "Limba",
      localeDe: "Germană",
      localeEn: "Engleză",
