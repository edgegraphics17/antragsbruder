...
const BOGEN_2: FoerderQuestion[] = [
  {
    ...
    options: [
      ...
      { value: 'MIETFREI', label: 'Mietfrei (z. B. Wohnrecht, durch Familie gestellt)' },
      { value: 'PARENTS', label: 'Bei Eltern / im Haushalt von Verwandten' },
      { value: 'OTHER', label: 'Andere Wohnform (z. B. Wohnheim, WG-Vertrag)' },
    ],
    relevantIf: () => true,
    fact: 'wohnform',
  },
  ...
  },
  {
    id: 'nebenkosten',
    bogen: 2,
    question: 'Wie hoch sind deine monatlichen Nebenkosten (kalte Betriebskosten)?',
  ...
  },
  {
    id: 'heizkosten',
    bogen: 2,
    question: 'Wie hoch sind deine monatlichen Heizkosten?',
    help: 'Heizung und Warmwasser zusammen, geschätzt.',
    type: 'money',
    min: 0,
    max: 5000,
    unit: '€ / Monat',
  ...
  },
  {
    ...
    type: 'bool',
    relevantIf: (f) => f.wohnform === 'RENT' || f.wohnform === 'OWN' || f.wohnform === 'OTHER',
