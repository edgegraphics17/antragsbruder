...
export type GsStage = 'angaben' | 'ergebnis' | 'unterlagen' | 'einreichen';

export const GS_STAGES: GsStage[] = ['angaben', 'ergebnis', 'unterlagen', 'einreichen'];
    ...
    (set, get) => ({
      ...
      resumeFromDb: (app, opts) => {
        ...
        set({
          ...
          userId: app.user_id,
          formState: keepLocal
            ? { ...app.form_state, ...local.formState }
            : app.form_state,
        });
      },
      ...
      saveToCloud: async (userId, caseId) => {
        ...
        const payload = {
          ...
          last_stage: s.stage,
          progress_percent: s.stage === 'einreichen' ? 90 : s.stage === 'unterlagen' ? 65 : 35,
        };
